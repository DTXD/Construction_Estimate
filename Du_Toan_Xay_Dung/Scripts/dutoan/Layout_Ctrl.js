...
function open_alert(state) {
    ...
    var elements = '';
    if (state == "success") {
        elements = '<div id="alert_success" style="color: #3c763d; background-color: #dff0d8; border-color: #d6e9c6; position: fixed; right: 1%; top:10%; opacity: 1; padding: 10px; border-radius: 4px; "><strong>Thành công !</strong>';
    }
    if (state == "fail") {
        elements = '<div id="alert_success" style="color: #a94442; background-color: #f2dede; border-color: #ebccd1; position: fixed; right: 1%; top:10%; opacity: 1; padding: 10px; border-radius: 4px; "><strong>Thất bại !</strong>';
    }
